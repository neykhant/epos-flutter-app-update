...
import '../../pages/buy/buy_detail_screen.dart';
...
class BuyShowScreen extends StatefulWidget {
  const BuyShowScreen({Key? key}) : super(key: key);

  @override
  _BuyShowScreenState createState() => _BuyShowScreenState();
}

class _BuyShowScreenState extends State<BuyShowScreen> {
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => BuyDetailScreen(
